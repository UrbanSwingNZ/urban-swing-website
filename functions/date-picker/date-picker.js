...
class DatePicker {
  ...
  /**
     ...
     * @return {Date|null} The selected date or null if no date is selected
     */
  getSelectedDate() {
  ...
  /**
     ...
     * @return {string|null} The selected date string (YYYY-MM-DD) or null if no date is selected
     */
